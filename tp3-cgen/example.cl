class Main {
  main(): IO {
    {
      io.out_string("Testing COOL Program\n");
...
class Shape {
  display(): IO {
    io.out_string("This is a generic shape\n")
  };
};
...
class Circle inherits Shape {
  ...
  display(): IO {
    io.out_string("This is a circle with radius ").out_int(radius).out_string("\n")
  };
...
class Rectangle inherits Shape {
  ...
  display(): IO {
    io.out_string("This is a rectangle\n")
  };
